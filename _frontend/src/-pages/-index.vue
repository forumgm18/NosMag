...
const ClarifyingSelectionPage = () => import(/* webpackChunkName: "clarifying-selection-page" */ '~/pages/catalog/_razdel/_alias')
const Razdel = () => import(/* webpackChunkName: "catalog" */ '~/pages/catalog/_razdel/_razdel2/_alias')
